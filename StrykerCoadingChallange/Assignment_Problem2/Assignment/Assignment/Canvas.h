...
protected:
	...
	//! Draw a Ellipse on the canvas at the specified location with the given radius and RGB color.
	//! \param cx       Ellipse center X coordinate in pixels.
	//! \param cy       Ellipse center Y coordinate in pixels.
	//! \param iWidth   Ellipse width in pixels from center.
	//! \param iHeight  Ellipse height in pixels from center.
	//! \param red      Red component of the RGB color (0-255).
	//! \param green    Green component of the RGB color (0-255).
	//! \param blue     Blue component of the RGB color (0-255).
	//! \if horOrVer	true then horizontal ellipse else vertical ellipse.
	void drawEllipse(GLint cx, GLint cy, GLuint iWidth, GLuint iHeight, GLubyte red, GLubyte green, GLubyte blue);
